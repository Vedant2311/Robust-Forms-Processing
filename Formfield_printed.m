...
% Locally adaptive thresholding : 0.59
...
% Removing the 18 highest eccentricities
    ...
    % > 58
    biggestBlobs = ismember(L,indexOfBiggest(1:(size(eccentricity) - 11)));
...
% Removing the lowest areas using 8 connected components
    ...
    biggestBlobs1 = ismember(L1,indexOfBiggest(1:100));
